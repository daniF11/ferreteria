...
<!-- Mirrored from freshcart.codescandy.com/dashboard/order-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2023 12:58:15 GMT -->
<head>
      <!-- Required meta tags -->
<meta charset="utf-8">
				...
				<li class="nav-item">
					...
					<div id="navCategoriesOrders" class="collapse  show " data-bs-parent="#sideNavbar">
						<ul class="nav flex-column">
							<li class="nav-item">
								<a class="nav-link  active " href="order-list.php">List</a>
							</li>
							<!-- Nav item -->
							<li class="nav-item">
