...
<!-- Mirrored from freshcart.codescandy.com/pages/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2023 12:57:28 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8" />
         ...
         <div class="container-fluid">
               ...
               <div class="col-xxl-9 col-lg-8">
                  <div class="d-flex align-items-center">
                     ...
                     <a class="navbar-brand d-none d-lg-block ms-4" href="../index.html">
                        <img src="../ferrehierros/logo.png" alt="eCommerce HTML Template" />
                     </a>
               ...
               <div class="col-xxl-3 col-lg-4 d-flex align-items-center justify-content-end">
                  ...
                  <div class="list-inline d-lg-block d-none">
                     <div class="list-inline-item me-5">
                        <a href="shop-wishlist.html" class="text-reset position-relative">
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              height="20"
            ...
            <div class="offcanvas offcanvas-start p-4 w-xxl-20 w-lg-30" id="navbar-default2">
               <div class="d-flex justify-content-between align-items-center mb-2">
                  <a href="../index.html"><img src="../ferrehierros/logo.png" alt="eCommerce HTML Template" /></a>
                  ...
                  <ul class="navbar-nav navbar-nav-offcanvac">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li>
                              <a class="dropdown-item" href="shop-single-2.html">Shop Single v2</a>
                           </li>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                           <li class="dropdown-submenu">
                              <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Dairy, Bread & Eggs</a>
                              <ul class="dropdown-menu">
                           ...
                           <li class="dropdown-submenu">
                              <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Vegetables & Fruits</a>
                              <ul class="dropdown-menu">
                           ...
                           <li class="dropdown-submenu">
                              <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Cold Drinks & Juices</a>
                              <ul class="dropdown-menu">
                     ...
                     <li class="nav-item dropdown dropdown-flyout">
                        <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Docs</a>
                        ...
                        <div>
                           ...
                           <nav>
                              <ul class="nav nav-pills nav-scroll border-bottom-0 gap-1" id="nav-tab" role="tablist">
                                 ...
                                 <li class="nav-item">
                                    <!-- nav link -->
                                    <a href="#" class="nav-link" id="nav-bakery-tab" data-bs-toggle="tab" data-bs-target="#nav-bakery" role="tab" aria-controls="nav-bakery" aria-selected="false">
                                       Bakery & Biscuits
                                    </a>
                                 </li>
                                 <!-- nav item -->
                                 <li class="nav-item">
                                    <!-- nav link -->
                                    <a href="#" class="nav-link" id="nav-tea-tab" data-bs-toggle="tab" data-bs-target="#nav-tea" role="tab" aria-controls="nav-tea" aria-selected="false">
                                       Tea, Coffee & Drinks
                                    </a>
                                 </li>
                                 <!-- nav item -->
                                 <li class="nav-item">
                                    <!-- nav link -->
                                    <a href="#" class="nav-link" id="nav-drinks-tab" data-bs-toggle="tab" data-bs-target="#nav-drinks" role="tab" aria-controls="nav-drinks" aria-selected="false">
                                       Cold Drinks & Juices
                                    </a>
                                 </li>
                              </ul>
                        ...
                        <div class="card-body position-relative text-center">
                           ...
                           <div class="mt-4">
                              <div class="progress mt-6" style="height: 8px">
                                 <div class="progress-bar bg-gray-400" role="progressbar" style="width: 88%" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <div class="my-3">
                                 <small>
                  ...
                  <div class="col mb-lg-0">
                     <div class="card card-product-v2 h-100">
                        <div class="card-body position-relative text-center">
                           ...
                           <div class="mt-4">
                              <div class="progress mt-6" style="height: 8px">
                                 <div class="progress-bar bg-gray-400" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <div class="my-3">
                                 <small>
                                    the available products :
                  ...
                  <div class="col mb-lg-0">
                     <div class="card card-product-v2 h-100">
                        <div class="card-body position-relative text-center">
                           ...
                           <div class="mt-4">
                              <div class="progress mt-6" style="height: 8px">
                                 <div class="progress-bar bg-gray-400" role="progressbar" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <div class="my-3">
                                 <small>
                                    the available products :
                  ...
                  <div class="col mb-lg-0">
                     <div class="card card-product-v2 h-100">
                        <div class="card-body position-relative text-center">
                           ...
                           <div class="mt-4">
                              <div class="progress mt-6" style="height: 8px">
                                 <div class="progress-bar bg-gray-400" role="progressbar" style="width: 78%" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <div class="my-3">
                                 <small>
                                    the available products :
                  ...
                  <div class="col mb-lg-0">
                     <div class="card card-product-v2 h-100">
                        <div class="card-body position-relative text-center">
                           ...
                           <div class="mt-4">
                              <div class="progress mt-6" style="height: 8px">
                                 <div class="progress-bar bg-gray-400" role="progressbar" style="width: 44%" aria-valuenow="44" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <div class="my-3">
                                 <small>
                                    the available products :
...
<!-- Mirrored from freshcart.codescandy.com/pages/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2023 12:57:32 GMT -->
</html>
