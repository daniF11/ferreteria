<div class="border-bottom">
      <div class="bg-light py-1">
         <div class="container">
            <div class="row">
               <div class="col-md-6 col-12 text-center text-md-start"><span>Contáctenos - 310 817 1292 - Las mejores ofertas </span></div>
            ...
            <div class="row w-100 align-items-center gx-lg-2 gx-0">
               <div class="col-xxl-2 col-lg-3 col-md-6 col-5">
                  <a class="navbar-brand d-none d-lg-block" href="index.php">
                     <img src="ferrehierros/logo.png" width="200" height="100" alt="eCommerce HTML Template" />
                  </a>
               ...
               <div class="col-xxl-5 col-lg-5 d-none d-lg-block">
                  <form action="#">
                     <div class="input-group">
                        <input class="form-control rounded" type="search" placeholder="Búsqueda de productos" />
         ...
         <div class="container">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
               <div class="offcanvas-header pb-1">
                  <a href="index.php"><img src="ferrehierros/logo.png" alt="eCommerce HTML Template" /></a>
               ...
               <div class="offcanvas-body">
                  ...
                  <div class="dropdown me-3 d-none d-lg-block">
                     <button class="btn btn-danger px-6" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="me-1">
                     ...
                     <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Herramientas manuales</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Herramientas eléctricas</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Materiales de construcción</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Fontanería</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Protección y seguridad</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Tornillería y similares</a></li>
                        <li><a class="dropdown-item" href="pages/shop-grid.php">Fijaciones y adhesivos</a></li>
                     </ul>
                  </div>
                  <div>
                     <ul class="navbar-nav align-items-center">
                        <li class="nav-item dropdown w-100 w-lg-auto">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="pages/index-4.php">Home 4</a></li>
                              <li>
                                 <a class="dropdown-item" href="pages/index-5.php">Home 5</a>
                              </li>
                           </ul>
                        </li>
                        <li class="nav-item dropdown w-100 w-lg-auto">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="pages/shop-grid-3-column.php">Shop Grid - 3 column</a></li>
                              ...
                              <li><a class="dropdown-item" href="pages/shop-single-2.php">Shop Single v2</a></li>
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li class="dropdown-submenu dropend">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="pages/account-payment-method.php">Payment Method</a></li>
                        ...
                        <li class="nav-item w-100 w-lg-auto">
                           <a class="nav-link" href="dashboard/index.php">Panel</a>
                        </li>
