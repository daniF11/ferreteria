...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2023 12:57:38 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8" />
                                 ...
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8 col-12 flex-grow-1">
                                       ...
                                       <div>
                                          ...
                                          <span class="text-muted small">5(69)</span>
                                       </div>
                                       <div class="mt-6">
                                          <!-- price -->
                                          <div><span class="text-dark">$14</span></div>
                                          <!-- btn -->
                                          <div class="mt-3">
                                             <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                                <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
                                    ...
                                    <div class="col-md-8 col-12 flex-grow-1">
                                       ...
                                       <div class="mt-6">
                                          ...
                                          <div>
                                             ...
                                             <span class="text-decoration-line-through text-muted">$9</span>
                                          </div>
                                          <!-- btn -->
                                          <div class="mt-3">
                                             <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                 ...
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8 col-12 flex-grow-1">
                                       ...
                                       <div>
                                          ...
                                          <span class="text-muted small">4.5(456)</span>
                                       </div>
                                       <div class="mt-6">
                                          <!-- price -->
                                          <div>
                                             <span class="text-dark">$13</span>
                                             <span class="text-decoration-line-through text-muted">$19</span>
                                          </div>
                                          <!-- btn -->
                                          <div class="mt-3">
                                             <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
